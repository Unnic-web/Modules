    ...
    def __init__(self):
        self.config = loader.ModuleConfig(
            loader.ConfigValue(
                "ignore_char",
                ".",
                lambda: "Символ, указывающий на игнорирование сообщения, измени на любой другой 1 символ. Это для того, что когда ты в Хикка вводишь команду, шоб форматирование текста не сбивало результаты той или инной введённой другой команды юзер бота.",
